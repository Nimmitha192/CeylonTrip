  ...
  return ( 
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16 "> 
      <div className="text-center space-y-4"> 
        <span className="text-2xl font-bold tracking-wider text-slate-700 block"> About&nbsp; 
        ...
        <div className="w-full text-center space-y-6"> 
          ...
          <p className="w-full text-sm sm:text-base text-slate-600 leading-7"> 
    ...
    <div className="rounded-3xl overflow-hidden shadow-card border border-slate-200 h-80 sm:h-100 relative"> 
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent flex items-end p-8"> 
            <p className="text-xs sm:text-sm font-medium leading-6 text-white"> 
    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-3"> 
        <div className="p-6 space-y-3 bg-slate-50 border rounded-2xl border-slate-200 shadow-soft"> 
            ...
            <h3 className="text-sm sm:text-base font-bold font-display text-slate-900">Smart Trip Planning</h3> 
        ...
        <div className="p-6 space-y-3 bg-slate-50 border rounded-2xl border-slate-200 shadow-soft"> 
            ...
            <h3 className="text-sm sm:text-base font-bold font-display text-slate-900">Discover Destinations on the Map</h3> 
            <p className="text-xs sm:text-sm leading-6 text-slate-600"> 
        ...
        <div className="p-6 space-y-3 bg-slate-50 border rounded-2xl border-slate-200 shadow-soft"> 
            ...
            <h3 className="text-sm sm:text-base font-bold font-display text-slate-900">AI & Intelligent Itinerary Optimization</h3> 
            <p className="text-xs sm:text-sm leading-6 text-slate-600"> 
      ...
      <div className="p-8 space-y-6 text-slate-800 border rounded-3xl bg-slate-50 border-slate-200"> 
        <div className="space-y-2"> 
            <span className="block text-xs font-bold tracking-widest uppercase text-emerald-600"> 
                Essential Traveler Insights 
            </span> 
            <h2 className="text-2xl font-bold text-slate-900 font-display sm:text-3xl"> 
                Practical Tips for Exploring the Pearl of the Indian Ocean 
            </h2> 
        </div> 
 
        <div className="grid grid-cols-1 gap-4 text-xs sm:text-sm leading-6 sm:grid-cols-2 text-slate-600"> 
            <div className="p-4 space-y-1 border rounded-xl bg-white border-slate-200"> 
                <h4 className="text-sm sm:text-base font-bold text-slate-700">Monsoon Seasons</h4> 
                <p> 
            ...
            <div className="p-4 space-y-1 border rounded-xl bg-white border-slate-200"> 
                <h4 className="text-sm sm:text-base font-bold text-slate-700">Sacred Shrine Etiquette</h4> 
                <p> 
          ...
          <div className="p-4 space-y-1 border rounded-xl bg-white border-slate-200"> 
            <h4 className="text-sm sm:text-base font-bold text-slate-700">Scenic Train Travel</h4> 
            <p> 
          ...
          <div className="p-4 space-y-1 border rounded-xl bg-white border-slate-200"> 
            <h4 className="text-sm sm:text-base font-bold text-slate-700">Currency & Local Payments</h4> 
            <p> 
